...
#define ERASE_B_MAX_X                                                          \
    (ERASE_B_MIN_X +                                                           \
     24) // height of the letter (16 bits) + 4 bits top/bottom padding
#define ERASE_B_MIN_Y (DRAW_MIN_Y)
#define ERASE_B_MAX_Y                                                          \
    (ERASE_B_MIN_Y + 50) // width of the 5 letters where each 8 bits + 5 bits
                         // left/right padding
